...
| `.Codex/skills/README.md`, `AGENTS.md` | **the author**, orienting or deciding | a stale map means skills drift apart unnoticed |
...
1. Read `.Codex/skills/README.md` — the map of skills and their boundaries. Every document
