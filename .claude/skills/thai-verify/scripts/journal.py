...
WATCHED = ("Thai A2", "Thai B1", "Helpers",
           ".claude/skills/thai-phonetics",
           ".claude/skills/thai-handwriting/references",
           ".claude/skills/thai-tasks/references",
           ".claude/skills/thai-mistakes",
           ".claude/skills/thai-learning",
           ".claude/skills/thai-display",
           ".claude/skills/thai-handwriting",
           ".claude/skills/thai-tasks",
           ".claude/skills/thai-verify")
...
def watched_files() -> List[pathlib.Path]:
    ...
    for extra in ("progress.json", "CLAUDE.md", "AGENTS.md", "RESOURCES.md",
