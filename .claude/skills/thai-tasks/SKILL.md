...
- **Подпункты внутри задания всегда маркируй буквами (а, б, в, …).** Если в одном
  ...
  пунктами с буквой, чтобы пользователь мог однозначно сослаться на «7б» в ответе и в
  разборе. Не давай несколько кейсов одной строкой через точку или тире. Пример:
