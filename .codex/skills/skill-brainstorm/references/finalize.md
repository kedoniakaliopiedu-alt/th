...
`.codex/brainstorms/*/изменения.md` and will propose reviewing work that is already done.
...
> `.codex/brainstorms/<тема>-<дата>/`? Если она закоммичена, всё достаётся обратно из
