...
description: >
  ...
  (SKILL.md and their references/), the skills README, AGENTS.md, and course
...
| `.codex/skills/MAP.md`, `README.md`, `AGENTS.md` | **the author**, orienting or deciding | a stale map means skills drift apart unnoticed |
...
1. Read `.codex/skills/MAP.md` — the map of skills and their boundaries. Every document
   you write sits somewhere on that map, and the map itself usually needs updating when you
   are done.
2. Read `AGENTS.md` — the rules that override everything else in this project.
